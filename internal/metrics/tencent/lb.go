...
func init() {
	metrics.RegisterNamespacePrefix("QCE/LB", "lb")
	...
	metrics.RegisterNamespacePrefix("QCE/LB_PUBLIC", "lb")
	metrics.RegisterNamespaceMetricAlias("QCE/LB_PUBLIC", map[string]string{
		"VipIntraffic":       "traffic_rx_bps",
		"VipOuttraffic":      "traffic_tx_bps",
		"VipInpkg":           "packet_rx",
		"VipOutpkg":          "packet_tx",
	...
	metrics.RegisterNamespaceHelp("QCE/LB_PUBLIC", func(metric string) string {
		switch metric {
		case "traffic_rx_bps":
			return " - LB 入方向带宽（bit/s）"
		case "traffic_tx_bps":
	...
	metrics.RegisterNamespacePrefix("QCE/LB_PRIVATE", "lb")
	metrics.RegisterNamespaceMetricAlias("QCE/LB_PRIVATE", map[string]string{
		"VipIntraffic":       "traffic_rx_bps",
		"VipOuttraffic":      "traffic_tx_bps",
		"VipInpkg":           "packet_rx",
		"VipOutpkg":          "packet_tx",
	...
	metrics.RegisterNamespaceHelp("QCE/LB_PRIVATE", func(metric string) string {
		switch metric {
		case "traffic_rx_bps":
			return " - LB 入方向带宽（bit/s）"
		case "traffic_tx_bps":
